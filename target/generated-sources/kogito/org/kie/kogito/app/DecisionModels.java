...
public class DecisionModels implements org.kie.kogito.decision.DecisionModels {
    ...
    private final static org.kie.dmn.api.core.DMNRuntime dmnRuntime = org.kie.kogito.dmn.DMNKogito.createGenericDMNRuntime(kieRuntimeFactoryFunction, readResource(Application.class.getResourceAsStream("/chaufferdrive.dmn")));
